  ...
  return (
    <>
      ...
      <div className="mt-5 container d-flex flex-column">
        <h1 className="pt-5 pb-5 align-items-lg-start text-center text-md-start align-items-center">Discover Recipe & Delicious Food</h1>
        <div className="d-flex flex-column">
          <div className="d-flex flex-xl-row flex-column align-items-xl-center justify-items-start">
            <input className="form-control me-0 me-xl-4" name="search" type="text" placeholder="Search" onChange={handleSearch}/>
            <button className="btn btn-warning p-2 border-0 mt-xl-0 mt-2" onClick={() => handleText()}>Search</button>
          </div>
          <div className="category d-flex flex-row mt-5 align-items-lg-start align-items-center justify-content-start text-center">
            <div className="row col-12">
              <div className="col-lg-2 col-6">
                <button onClick={handleSort} className="btn-category border-0 bg-warning rounded px-5 inline-block py-2">New</button>
              </div>
              <div className="col-lg-2 col-6 ">
                <button className="btn-category border-0 bg-warning rounded px-4 inline-block py-2">Popular</button>
              </div>
              <div className="col-lg-2 col-6 mt-4 mt-lg-0">
                <button className="btn-category border-0 bg-warning rounded px-4 inline-block py-2">Vegetarian</button>
              </div>
              <div className="col-lg-2 col-6 mt-4 mt-lg-0">
                <button className="btn-category border-0 bg-warning rounded px-4 inline-block py-2">Breakfast</button>
              </div>
            </div>
          </div>
        </div>
      ...
      {data.length > 0 ? (
        data.map((item) => (
            ...
            <div className="d-flex flex-lg-row flex-column align-items-center text-center mt-5 mb-5">
              <img className="" width={350} src={item.photo} alt="img" />
