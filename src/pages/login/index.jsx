    ...
    <section>
      <div className="container">
        ...
        <form onSubmit={handleSubmit} className='w-100 align-items-center justify-content-center d-flex flex-column'>
          ...
          <button type="submit" className="button bg-warning text-white col-lg-6 col-8 p-2 mt-3 border-0 rounded">Login</button>
          {data.isLoading && <p className="mt-2">Please wait</p>}
          {data.error && <p className="mt-2">Login Failed, wrong email or password</p>}
          <p className="mt-2 align-items-start col-lg-6 col-8">Forgot your password? <Link to="/ForgotPassword" className="text-warning text-decoration-none">Click Here</Link></p>
